...
static Key keys[] = {
	...
	{ MODKEY,                       XK_m,                       spawn,          SHCMD("pactl set-sink-mute @DEFAULT_SINK@ toggle; pkill -RTMIN+1 dwmblocks") },
 	...
 	{ MODKEY|ShiftMask,             XK_bracketleft,             spawn,          SHCMD("xbacklight -dec 10") },
   	...
   	{ MODKEY,                       XK_F3,                      spawn,          SHCMD("maimclip -f") },
   	{ MODKEY|ShiftMask,             XK_F1,                      spawn,          SHCMD("maimpick -s") },
   	{ 0,                            XK_Print,                   spawn,          SHCMD("maimpick -f") },
   	{ MODKEY|ShiftMask,             XK_F2,                      spawn,          SHCMD("maimpick -w") },
   	{ MODKEY|ShiftMask,             XK_F3,                      spawn,          SHCMD("maimpick -f") },
