...
static Key keys[] = {
	...
	{ MODKEY,                       XK_m,                       spawn,          SHCMD("pactl set-sink-mute @DEFAULT_SINK@ toggle; pkill -RTMIN+1 dwmblocks") },
 	...
 	{ MODKEY|ShiftMask,             XK_bracketleft,             spawn,          SHCMD("xbacklight -dec 10") },
   	{ 0,                            XK_Print,                   spawn,          SHCMD("maimpick -f") },
   	{ MODKEY,                       XK_F1,                      spawn,          SHCMD("maimpick -s") },
   	{ MODKEY,                       XK_F2,                      spawn,          SHCMD("maimpick -w") },
   	{ MODKEY,                       XK_F3,                      spawn,          SHCMD("maimpick -f") },
   	{ MODKEY|ShiftMask,             XK_F1,                      spawn,          SHCMD("maimclip -s") },
   	{ MODKEY|ShiftMask,             XK_F2,                      spawn,          SHCMD("maimclip -w") },
   	{ MODKEY|ShiftMask,             XK_F3,                      spawn,          SHCMD("maimclip -f") },
