...
static const char *fonts[]          = { "monospace:style=bold:pixelsize=15", "Noto Color Emoji:style=Regular:pixelsize=14:antialias=true:autohint=true" };
...
const char *spcmd2[] = {TERMINAL, "-n", "spcalc", "-f", "monospace:pixelsize=20:antialias=true:autohint=true", "-g", "40x10", "-e", "bc", "-lq", NULL };
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,     XK_Return,          togglescratch,      {.ui = 0} }, /* dropdown terminal */
